<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"E:\GIT\kevin\thinkphp\public/../application/index\view\userinfo\userList.html";i:1505113769;s:73:"E:\GIT\kevin\thinkphp\public/../application/index\view\common\header.html";i:1505138052;s:71:"E:\GIT\kevin\thinkphp\public/../application/index\view\common\menu.html";i:1505219436;s:73:"E:\GIT\kevin\thinkphp\public/../application/index\view\common\footer.html";i:1505113769;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont"></i> 首页 <span class="c-gray en">&gt;</span> 用户管理 <span class="c-gray en">&gt;</span> 用户管理 <a title="刷新" href="javascript:location.replace(location.href);" style="line-height:1.6em;margin-top:3px" class="btn btn-success radius r"><i class="Hui-iconfont"></i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-danger radius" onclick="datadel()" href="javascript:;"><i class="Hui-iconfont"></i> 批量删除</a> <a  href="<?php echo url('Userinfo/user_add'); ?>" class="btn btn-primary radius"><i class="Hui-iconfont"></i> 添加用户</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
			<div class="mt-10">
				...
				<tbody>
					<tr class="text-c">
						...
						<!-- <a style="text-decoration:none" onclick="admin_role_edit('角色编辑','role_add.html','1')" href="javascript:;" title="编辑"><i class="Hui-iconfont"></i></a> -->
						 <a style="text-decoration:none" class="del ml-5" onclick="admin_role_del(this,'1')" attr="" href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a>
						 </td>
					</tr>
				</tbody>
			</table>
...
function admin_role_del(obj,id){
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
		...
		// var id = $(this).attr();
		var id = $(".del").attr("attr");
		
		$.ajax({
		   type: "POST",
		   url: "<?php echo url('Userinfo/user_del'); ?>",
		   data: {id:id},
