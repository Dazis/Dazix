<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\gg\thinkphp\public/../application/index\view\Jurisdiction\role_update.html";i:1505467470;s:66:"D:\gg\thinkphp\public/../application/index\view\common\header.html";i:1505467470;s:64:"D:\gg\thinkphp\public/../application/index\view\common\menu.html";i:1505467470;s:66:"D:\gg\thinkphp\public/../application/index\view\common\footer.html";i:1505467470;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="pd-20">
  <form action="<?php echo url('Jurisdiction/update_role'); ?>" method="post" class="form form-horizontal" id="form-user-add">
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>角色名称：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?= $data['role']?>" placeholder="" id="user-name" name="role">
      </div>
      <div class="col-5"> </div>
    </div>
