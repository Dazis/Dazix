...
<div class="pd-20">
  <form action="<?php echo url('Jurisdiction/update_jsdt'); ?>" method="post" class="form form-horizontal" id="form-user-add">
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>权限名称：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?= $data['noteName']?>" placeholder="" id="user-name" name="noteName">
      </div>
      <div class="col-5"> </div>
    </div>
    <input type="hidden" class="input-text" value="<?= $data['noteId']?>" placeholder="" id="user-name" name="noteId">
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>控制器/方法：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?= $data['noteRoad']?>" placeholder="" id="user-name" name="noteRoad">
      </div>
      <div class="col-5"> </div>
    </div>
    <!-- <div class="row cl">
