<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\jurisdiction\jsdt_add.html";i:1504274116;s:76:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\common\header.html";i:1504188788;s:74:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\common\menu.html";i:1504609700;s:76:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\common\footer.html";i:1504188778;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="pd-20">
  <form action="<?php echo url('Jurisdiction/jsdt'); ?>" method="post" class="form form-horizontal" id="form-user-add">
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="user-name" name="controllers">
      </div>
      <div class="col-5"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="user-name" name="actions">
      </div>
      <div class="col-5"> </div>
    </div>
    <!-- <div class="row cl">
