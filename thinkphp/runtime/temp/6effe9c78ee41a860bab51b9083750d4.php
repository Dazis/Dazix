<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\gg\thinkphp\public/../application/index\view\product\pro_list.html";i:1505467470;s:66:"D:\gg\thinkphp\public/../application/index\view\common\header.html";i:1505467470;s:64:"D:\gg\thinkphp\public/../application/index\view\common\menu.html";i:1505467470;s:66:"D:\gg\thinkphp\public/../application/index\view\common\footer.html";i:1505467470;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<table class="table table-border table-bordered table-hover table-bg">
				<thead>
					<tr>
						<th colspan="8" scope="col">角色管理</th>
					</tr>
					<tr class="text-c">
						<th width="25"><input type="checkbox" name="" value=""></th>
						<th width="40">标题昵称</th>
						<th width="200">标题图片</th>
						<th width="200">健康介绍</th>
						<th width="300">健康内容</th>
						<th width="40">所属健康分类</th>
						<th width="100">创建健康文章时间</th>
						<th width="70">操作</th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($res as $key => $value): ?>
					<tr class="text-c aaa" attr="">
						...
						<td><?= $value['title'] ?></td>
						<td><img src="../../../uploads/<?= $value['img'] ?>" alt="" width="50px;"></td>
						<td><?= $value['intro'] ?></td>
						<td><?= $value['content'] ?></td>
						<td><?= $value['type_name'] ?></td>
						<td><?= $value['created_time'], date('Y-m-d H:i:s') ?></td>
						<td class="f-14">
