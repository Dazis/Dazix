<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\jurisdiction\amstt.html";i:1505056700;s:76:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\common\header.html";i:1504188788;s:74:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\common\menu.html";i:1504609700;s:76:"D:\phpStudy\WWW\thinkphp\public/../application/index\view\common\footer.html";i:1504188778;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont"></i> 首页
		...
		管理员管理
		<span class="c-gray en">&gt;</span>
		管理员列表 <a title="刷新" href="javascript:location.replace(location.href);" style="line-height:1.6em;margin-top:3px" class="btn btn-success radius r"><i class="Hui-iconfont"></i></a> </nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"> <a class="btn btn-danger radius" onclick="datadel()" href="javascript:;"><i class="Hui-iconfont"></i> 批量删除</a> <a class="btn btn-primary radius" href="<?php echo url('Jurisdiction/amstt_add'); ?>"><i class="Hui-iconfont"></i> 添加管理员</a> </span>
				<span class="r">共有数据：<strong>54</strong> 条</span>
			</div>
			<table class="table table-border table-bordered table-bg">
				<thead>
					<tr>
						<th colspan="9" scope="col">员工列表</th>
					</tr>
					<tr class="text-c">
				...
				<tbody>
					<tr class="text-c">
						...
						<td class="td-manage"><a title="启用" href="javascript:;" onclick="admin_start(this,'10001')" style="text-decoration:none"><i class="Hui-iconfont"></i></a> <a style="text-decoration:none" class="ml-5" onclick="admin_edit('管理员编辑','amstt_add.html','2','800','500')" href="javascript:;" title="编辑"><i class="Hui-iconfont"></i></a> <a style="text-decoration:none" class="ml-5" onclick="admin_del(this,'1')" href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a></td>
					</tr>
				</tbody>
			</table>
		</article>
