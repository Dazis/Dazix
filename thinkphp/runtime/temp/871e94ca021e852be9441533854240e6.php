<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\gg\thinkphp\public/../application/index\view\collection\show.html";i:1505225975;s:66:"D:\gg\thinkphp\public/../application/index\view\common\header.html";i:1504188788;s:64:"D:\gg\thinkphp\public/../application/index\view\common\menu.html";i:1505100653;s:66:"D:\gg\thinkphp\public/../application/index\view\common\footer.html";i:1504188778;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-danger radius" onclick="datadel()" href="javascript:;"><i class="Hui-iconfont"></i> 批量删除</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<?php foreach ($res as $key => $value): ?>
					<tr class="text-c">
						...
						<a style="text-decoration:none" class="ml-5" onclick="admin_role_del(this,'1')" href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a></td>
					</tr>
				<?php endforeach ?>	
				</tbody>
			</table>
