<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"E:\GIT\kevin\thinkphp\public/../application/index\view\product\product_add.html";i:1505139159;s:73:"E:\GIT\kevin\thinkphp\public/../application/index\view\common\header.html";i:1505138052;s:71:"E:\GIT\kevin\thinkphp\public/../application/index\view\common\menu.html";i:1505373160;s:73:"E:\GIT\kevin\thinkphp\public/../application/index\view\common\footer.html";i:1505113769;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="pd-20">
  <form action="<?php echo url('Product/product_add_do'); ?>" method="post" class="form form-horizontal" id="form-user-add"  enctype="multipart/form-data">
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题昵称：</label>
    ...
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>健康介绍：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="user-name" name="intro">
      </div>
      <div class="col-5"> </div>
    </div>

    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>健康内容：</label>
      <div class="formControls col-5">
      <textarea name="content" id="" cols="30" rows="10" class="input-text"></textarea>
      </div>
      <div class="col-5"> </div>
    </div>
	...
	<div class="row cl">
      <div class="row cl">
        ...
        <div class="formControls col-5">
          <input type="file" class="input-img" value="" placeholder="" id="user-name" name="img">
        </div>
        <div class="col-5"> </div>
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>所属健康分类：</label>
        <div class="formControls col-5">
          <select name="id" id="" class="input-option">
