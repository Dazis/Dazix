<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\product\type_list.html";i:1505462073;s:88:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\common\header.html";i:1504188788;s:86:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\common\menu.html";i:1505100653;s:88:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\common\footer.html";i:1504188778;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a  href="<?php echo url('Product/product_type_add'); ?>" class="btn btn-primary radius"><i class="Hui-iconfont"></i> 添加分类</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<?php foreach($res as $k=>$v){?>
					<tr class="text-c">
						...
						<?php } ?>
						<td class="f-14">
						 <a style="text-decoration:none" class="ml-5 td-status" urls="<?= $v['id']?>" onclick="admin_role_del(this,'1')" href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a>
						 </td>
					</tr>
				<?php } ?>
				</tbody>
...
function admin_role_del(obj,id){
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
		...
		$.ajax({
		    type: "POST",
		    url: "<?php echo url('Product/del_article_type'); ?>",
		    data: {id:id},
		    success: function(msg){
		    	if (msg == 1) {
		    		...
		    		layer.msg('不能删主分类!',{icon:1,time:1000});
		    	}
