<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\product\type_list.html";i:1505395303;s:88:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\common\header.html";i:1504188788;s:86:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\common\menu.html";i:1505100653;s:88:"D:\domainname\Souhujiankang\thinkphp\public/../application/index\view\common\footer.html";i:1504188778;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
			...
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<?php foreach($res as $k=>$v){?>
					<tr class="text-c">
						...
						<td><?= $v['add_time']?></td>
						<td class="f-14">
						 <a style="text-decoration:none" urls="<?= $v['id']?>" class="ml-5 td-status" onclick="admin_role_del(this,'1')" href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a>
						 </td>
					</tr>
				<?php } ?>
				</tbody>
		...
		$.ajax({
		    ...
		    success: function(msg){
		    	...
		    	if(msg == 3) {
					...
					layer.msg('不能删除总分类!',{icon:1,time:1000});
		    	} else {
		    		$(obj).parents("tr").remove();
