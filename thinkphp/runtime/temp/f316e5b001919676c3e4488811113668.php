			...
			<table class="table table-border table-bordered table-bg">
				...
				<tbody>
					<tr class="text-c">
						...
						<td>1</td>
						<td>1</td>
						<td><a style="text-decoration:none" class="ml-5" onclick="admin_permission_edit('角色编辑','jsdt_add.html','1','','310')" href="javascript:;" title="编辑"><i class="Hui-iconfont"></i></a> <a style="text-decoration:none" class="ml-5" onclick="admin_permission_del(this,'1')" href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a></td>
					</tr>
				</tbody>
			</table>
		</article>
