...
<div class="pd-20">
  <form action="<?php echo url('Jurisdiction/role'); ?>" method="post" class="form form-horizontal" id="form-user-add">
    <div class="row cl">
