      ...
      <table class="table table-border table-bordered table-bg">
        ...
        <tbody>
          <tr class="text-c">
            ...
            <td>1</td>
            <td>1</td>
            <td><a href="<?php echo url('Jurisdiction/role_jsdt_add'); ?>">添加</a></td>
            <td>
            <a style="text-decoration:none" class="ml-5"  href="<?php echo url('Jurisdiction/role_add'); ?>" title="编辑"><i class="Hui-iconfont"></i></a> 
