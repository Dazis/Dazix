  ...
  <div class="row">
    ...
    <div class="table-wraper">
      <ul class="nav nav-tabs icons">
        <li><a href="/signup"><i class="img-cellphone"></i>手机注册</a></li>
        <li><span>|</span></li>
        <li class="active"><a href="/signup?signupType=email"><i class="img-email"></i>邮箱注册</a></li>
      </ul>
...
<![endif]-->
<script type="text/javascript" src="../js/regemail.js"></script>
</body>
</html>